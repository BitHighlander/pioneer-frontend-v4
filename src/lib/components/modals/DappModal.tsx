        ...
        <TabPanels>
          ...
          <TabPanel>
            ...
            <FormControl>
              ...
              />
              <FormHelperText>
                Homepage is the Landing, generally designed to be indexed by
                crawlers.
              </FormHelperText>
            </FormControl>
            <FormControl>
              ...
              />
              <FormHelperText>
                Enter the URL of the dapp application itself, generally
                app.serviceName*.com
              </FormHelperText>
            </FormControl>
            <FormControl>
              ...
              <FormHelperText>
                Enter the URL of the image for the Dapp. This MUST be a valid
                URL and not an encoding!
              </FormHelperText>
            </FormControl>
            <FormControl>
