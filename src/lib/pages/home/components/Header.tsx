        ...
        <Flex alignItems="start" justifyContent="space-between">
          <Box p={5}>
            ...
            <Text as="cite" fontSize="md" mb={4}>
              "Pioneer is a human assisted AI project designed to chart and
              track the fast moving blockchain space"
            </Text>
            <br />
            <VStack spacing={4} alignItems="start">
              ...
              <Box>
                ...
                <Button
                  ...
                  size="lg"
                  colorScheme="green"
                  onClick={() => handleButtonClick("/blockchains")}
                >
                  Explore Blockchains
                </Button>
                <Button
                ...
                <Button
                  ...
                  size="lg"
                  colorScheme="green"
                  onClick={() => handleButtonClick("/pioneers")}
                >
                  Leaderboard
                </Button>
              </Box>
